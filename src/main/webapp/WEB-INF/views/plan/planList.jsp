					...
					<div class="rd-text">
						<div class="room-booking">
							...
							<section class="new-plan">
								<div class="col-lg-4">
									<form action="/plan/planContent" method="get" name="plan-form" onsubmit="return check();">
										<!-- Button trigger modal -->
										<button type="button" class="add-group" data-bs-toggle="modal" data-bs-target="#exampleModal" onclick="addPlan(event, ${license}, ${grpList.size() });">
											플랜 생성하기</button>
										<!-- Modal -->
						...
						<c:if test="${license eq 'free' }">
							...
							<a href="javascript:void(0)" class="buy-subscription">프리미엄
								회원으로 업그레이드하기</a>
						</c:if>
					</div>
				</div>
...
<script
	src="${pageContext.request.contextPath }/resources/js/plan/planList.js"></script>
