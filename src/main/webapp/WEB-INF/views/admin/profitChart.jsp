            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb-text">
                        ...
                        <div id="pmSort">
					    <input type="button" value="월별 매출" class="w-btn w-btn-indigo" onclick="location.href='/pmMembers?date=${param.date}';">
					    <input type="button" value="연도별 매출" class="w-btn w-btn-indigo" onclick="location.href='/periodMems?date=${param.date}';">
					    </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <div class="chart-area"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
                                        <div id="curve_chart" style="display: block; height: 320px; width: 781px;" class="chartjs-render-monitor"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
