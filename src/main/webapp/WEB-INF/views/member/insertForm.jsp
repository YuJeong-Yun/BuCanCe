...
<div class = "memberInputArea">
    	<form action="${pageContext.request.contextPath }/insert" method="post" onsubmit="return checkForm()">
			...
			<span class = "memberInputGroup"><input type="text" class = "inputBox" name="user_name"  id = "user_name" placeholder="이름"></span>
			<span class = "memberInputGroup"><input type="text" class = "inputBox" name="email"  id = "email" placeholder = "이메일"></span>
			<span class = "memberInputGroup"><input type="text" class = "inputBox" name="tel" id = "tel" placeholder =  "전화번호"></span>
