...
<div class="w3-content" style="max-width:1000px">
  <img class="mySlides" src="${roomdetail.get(a).room_pic}" style="width:100%;">

  <div class="w3-row-padding w3-section">
<%--   	<c:forEach items="${roomdetail}" begin="0" end="1"> --%>
  	 <div class="w3-col s4">
      <img class="demo w3-opacity w3-hover-opacity-off" src="${roomdetail.get(a).room_pic}" style="width:100%;cursor:pointer" onclick="currentDiv(2)" width="180" height="130">
    </div>
<%--   	</c:forEach> --%>
  </div>
</div>
