...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/css/acc/yd.css">
						...
						<div class="rd-title">
							...
							<div class="rdt-right">
								<div class="rating">${roomdetail.get(0).room_star}
									...
									<h5>별점 :${roomdetail.get(0).room_star_num} 점</h5>
								</div>
			...
			<div class="col-lg-4">
				<div class="room-booking"
					...
					<form
						...
						method="GET" name="dateForm">
						<input type="hidden" name="bno" value="${bno}"> <input
							type="hidden" name="ano" value="${ano}"> <input
							type="hidden" name="room_title"
							value="${roomdetail.get(0).room_title}">
						<div class="check-date">
							<label for="date-in"><b>체크인</b></label> <input type="text"
								class="date-input" id="date-in" value="${param.sel_date}"
								name="sel_date"> <i class="icon_calendar"></i>
						</div>
						<div class="check-date">
							<label for="date-out"><b>체크 아웃</b></label> <input type="text"
								class="date-input" id="date-out" value="${param.sel_date2}"
