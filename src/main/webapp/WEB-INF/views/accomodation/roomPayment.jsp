			...
			<div class="row">
				<div class="col-lg-8">
					<div class="room-details-item">
						<img
							src="${pageContext.request.contextPath}/resources/img/room/room-details.jpg"
							alt="">
						<div class="rd-text">
							<div class="rd-title">
							...
							<table>
								<tbody>
									...
									<tr>
										...
										신용/체크카드</option>
										<option data-minprice="0" value="naverpay" data-v-f785cca6="">
										네이버페이</option>
						...
						<form action="#">
							...
							<div class="check-date">
								<label for="date-out"><strong>총 결제 금액</strong></label> <input
									type="text" id="date-out"> <i class=""></i>
							</div>
...
// 	    	  pg: "html5_inicis",
// 	    	  pg: "kakaopay", //바꾸는값 결제수단 
// 	    	  pg: "tosspay", //바꾸는값 결제수단
	          pay_method: "card",
	          merchant_uid: "ORD20180131-00000121",  //고유 id
	          name: "냉동참치",  //상품이름
	          amount: 100, //가격
	          buyer_email: "kld9223@naver.com",
	          buyer_name: "하영득",
	          buyer_tel: "010-3795-9228",
	          buyer_addr: "부산광역시 금정구 금정로 233-21번길 한진스카이 아파트 1003호",
	          buyer_postcode: "46243"
