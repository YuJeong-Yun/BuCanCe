...
<!-- 								</a>  -->
				...
				<button type="button" class="btn" class="btn btn-block btn-primary btn-sm" onclick="${pageContext.request.contextPath}/accomodation/roomList"><b>1번 페이지</b></button><p></p>
				 <button type="button" class="btn btn-block btn-primary btn-sm" onclick="${pageContext.request.contextPath}/accomodation/roomList3"><b>3번 페이지</b></button><p></p>
			</div>
		</div>
	</section>
	</section>
