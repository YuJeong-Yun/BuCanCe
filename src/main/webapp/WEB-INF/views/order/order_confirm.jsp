			...
			.ready(
					function() {
						...
						var getResult = function(res) {
							...
							var url = "/order/order_result.jsp";
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="breadcrumb-text">
						...
						<table style="color: #40C4FF; margin: 0 auto; padding: 3em;">
							<colgroup>
							...
							<h2>구독권 결제 요청</h2>
							<div class="bt-option">
								<span style="padding: 1em;">최종 결제 정보를 확인해주세요</span>
							</div>
							<br>
						...
						<br>
						<button class="btn btn-info" id="payAction"
							style="margin: 0 auto; margin: 1em; background-color: #0091EA;">결제하기</button>
