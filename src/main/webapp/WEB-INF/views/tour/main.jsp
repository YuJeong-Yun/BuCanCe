...
<jsp:include page="../include/headerJin.jsp" />
    ...
    <section class="hero-section">
        ...
        <div class="hero-slider owl-carousel">
            <div class="hs-item set-bg" data-setbg="${pageContext.request.contextPath}/resources/img/busan/busan1.jpg"></div>
            <div class="hs-item set-bg" data-setbg="${pageContext.request.contextPath}/resources/img/busan/busan2.jpg"></div>
            <div class="hs-item set-bg" data-setbg="${pageContext.request.contextPath}/resources/img/busan/busan3.jpg"></div>
        </div>
    </section>
    <!-- Hero Section End -->
