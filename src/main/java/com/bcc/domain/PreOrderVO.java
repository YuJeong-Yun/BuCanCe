...
public class PreOrderVO {
	...
	private String periodic_pm; //결제내역
	private Date next_order_date; //다음결제일
	private String PCD_PAYER_ID; //빌링키
	
	public PreOrderVO(String id, Date credate_date, Date license_deadline, Date next_order_date, String periodic_pm,
			String pCD_PAYER_ID) {
		super();
		this.id = id;
	...
	public String toString() {
		return "PreOrderVO [PCD_PAY_OID=" + PCD_PAY_OID + ", id=" + id + ", credate_date=" + credate_date
				+ ", license_deadline=" + license_deadline + ", periodic_pm=" + periodic_pm + ", next_order_date="
				+ next_order_date + ", PCD_PAYER_ID=" + PCD_PAYER_ID + "]";
	}
